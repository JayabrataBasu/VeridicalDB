...
func (u *UsersScreen) palette() (accent, highlight, muted, border, selectionBg, selectionFg, text string) {
	accent = "#00D9FF"
	highlight = "#FF006E"
	muted = "#44475A"
	border = "#3a3a5c"
...
func (u *UsersScreen) View() string {
	accent, highlight, muted, border, selectionBg, selectionFg, text := u.palette()
